    ...
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxs(
        Box,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Typography, { variant: "h4", component: "h1", gutterBottom: true, children: "Oops! Something went wrong" }),
            /* @__PURE__ */ jsx(Typography, { variant: "body1", color: "text.secondary", paragraph: true, children: this.state.error?.message || "An unexpected error occurred" }),
            /* @__PURE__ */ jsx(
              Button,
              {
                variant: "contained",
...
import { Box as Box3, Container } from "@mui/material";

// src/components/Navigation.tsx
import { AppBar, Toolbar, Typography as Typography2, Button as Button2, Box as Box2 } from "@mui/material";
...
var Navigation = () => {
  return /* @__PURE__ */ jsx2(AppBar, { position: "static", children: /* @__PURE__ */ jsxs2(Toolbar, { children: [
    /* @__PURE__ */ jsx2(
      Typography2,
      {
        variant: "h6",
...
var Layout = ({ children }) => {
  return /* @__PURE__ */ jsxs3(Box3, { sx: { display: "flex", flexDirection: "column", minHeight: "100vh" }, children: [
    /* @__PURE__ */ jsx3(Navigation, {}),
    /* @__PURE__ */ jsx3(Container, { component: "main", sx: { flex: 1, py: 4 }, children })
  ] });
};
export {
  ErrorBoundary,
